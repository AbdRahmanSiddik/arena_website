<div>
  <div data-tw-backdrop="" aria-hidden="true" tabindex="-1" id="add-kategori"
    ...
    <div data-tw-merge=""
      ...
      <div data-tw-merge="" class="flex items-center border-b border-slate-200/60 dark:border-darkmode-400 px-6 py-5">
        <h2 class="mr-auto text-base font-medium">Tambah Kategori</h2>
      </div>
      <div data-tw-merge="" class="overflow-y-auto flex-1 p-0">
        <div class="flex flex-col gap-3.5 px-5 py-3">

          <!-- BEGIN: Validation Form -->
          <form class="" method="POST" action="{{ route('admin.kategori-store') }}">
            @csrf
